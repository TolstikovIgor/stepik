...
Для тех книг в таблице book, которые есть в таблице supply, но по другой цене, не только увеличить их количество в таблице book (увеличить их количество на значение столбца amount таблицы supply), но и пересчитать их цену (найти общую сумму цен из таблиц book и supply и разделить на кол-во книг)*/
UPDATE book, supply 
